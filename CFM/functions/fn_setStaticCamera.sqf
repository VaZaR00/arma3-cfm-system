/*
	...
	Arguments:
		...
		4. _hasTInNvg - array of [bool, bool] if operator has nvg and ti
		4. _params - other
*/
...
private _dummyObj = ["createDummyForStaticCam"] CALL_CLASS("DbHandler");
...
private _turrs = [];
{
	_x params [["_pos", [0,0,0], [[]], 3], ["_vDirUp", [], [[]], 2], ["_turretIndex", -2], ["_zoomTable", []], ["_nvgAndTi", []], ["_turrName", _name]];
